...
arithmetics, random numbers, time operations, and other examples like small
...
built and tested every time a change is made. The compiled executables will be
placed under `build`.

```bash
git clone https://github.com/marcbperez/c-programming-security.git
cd c-programming-security.git
